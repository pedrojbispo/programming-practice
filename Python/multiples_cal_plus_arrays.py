...
print()
# Print specific number of the array by its position index
print("In position 50 the number is:", m[50])
# Print an empty space
print()
# Print the index of a specific number in the array. Warning using index() method, the value must exist on the array.
print("The number 100 is at the position:", m.index(100))
# Print an empty space
print()
# Extra array methods.
...
# Print an empty space
print()
print("Array count repeated values:", m_edited.count(2), "\nArray Length:", len(m_edited), "\n")
m_edited_not_sorted = m_edited.copy()
# Print an empty space
print()
# Sort the Array
m_edited_sorted = m_edited_not_sorted.copy()
m_edited_sorted.sort()
