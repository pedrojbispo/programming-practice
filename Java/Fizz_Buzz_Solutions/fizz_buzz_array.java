...
public class fizz_buzz_array {
    public static void main(String[] args){
        ...
        System.out.println("Fizz Numbers: " + fizz);
        System.out.println("Buzz Numbers: " + buzz);
        System.out.println("FizzBuzz Numbers: " + fizzbuzz);
        System.out.println("Out Numbers: " + outnumbers);
    }
}
